import { type RegExpMatchObject, type ReplaceFunction, findAndReplace } from "mdast-util-find-and-replace";
...
export type BuildUrlValues = CommitBuildUrlValues | CompareBuildUrlValues | IssueBuildUrlValues | MentionBuildUrlValues;
